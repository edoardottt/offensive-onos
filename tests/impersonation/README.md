...
We can observe that in the file impersonation.pcap H2 will receive ICMP echo requests from H1, this means that the attack succeeded. H2 then can impersonate H4 sending ICMP echo replies back to H1.  
